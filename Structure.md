...
"Рецепт" - отвечает за общие для ресурсов методы, и входные условия, наследники меняют результат

## CraftRecipe

Наследник Recipe, создающий простые сущности (ресурсы или боевые пешки)

## BuildRecipe

Наследник Recipe, создающий новые строения на месте чертежа

## WorkerRecipe

Наследник Recipe, создающий рабочие пешки, или обучающий их новым профессиям
...
"Сущность" наследниками которой являются практически все внутриигровые объекты, имеет внутри общие для всех
характеристики
...
Осуществляет взаимодействие между действиями игрока на "побочных" окнах(настройки/меню выбора рецепта/построки...) и
внутренней логикой
...
По сути Factory для packet, создает пакет в нужном формате с описанием событий с сервера
